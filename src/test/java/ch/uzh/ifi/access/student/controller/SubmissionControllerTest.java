...
public class SubmissionControllerTest {
    ...
    private CourseAuthentication authentication;

    private Exercise exercise = TestObjectFactory.createCodeExercise("");
    private final String exerciseId = exercise.getId();
    ...
    public void submitMultipleChoices() throws Exception {
        ...
        StudentSubmission submission = repository.findTopByExerciseIdAndUserIdOrderByVersionDesc(exerciseId, authentication.getUserId()).orElse(null);
        Assertions.assertThat(submission).isNotNull();
        Assertions.assertThat(submission.getExerciseId()).isEqualTo(exerciseId);
