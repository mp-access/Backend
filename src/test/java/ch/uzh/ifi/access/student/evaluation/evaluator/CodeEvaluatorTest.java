...
public class CodeEvaluatorTest {
    ...
    private SubmissionEvaluation evaluate(String output) {
        ...
        return new CodeEvaluator().evaluate(sub, exercise);
    }

    private static List<String> extractAllHints(String output) {
        return new CodeEvaluator().parseHintsFromLog(output);
    }
    ...
    public void execWithFailures() {
        SubmissionEvaluation grade = evaluate("test_isupper (test.TestStringMethods1.TestStringMethods1) ... ok\n"
                ...
                + "----------------------------------------------------------------------\n"
                + "Traceback (most recent call last):\n"
                + "  File \"/path/to/test/tests.py\", line 6, in test_upper\n"
    ...
    public void parseHintsOnlyAssertionErrorMsg() {
        SubmissionEvaluation grade = evaluate("test_doghouse (testSuite.Task2B) ... FAIL\n" + "\n"
                ...
                + "----------------------------------------------------------------------\n"
                + "Traceback (most recent call last):\n"
                + "  File \"/path/to/test/tests.py\", line 29, in test_doghouse\n"
    ...
    public void hintsNotParsed() {
        String output = "........FF..\n" + "======================================================================\n"
                ...
                + "----------------------------------------------------------------------\n"
                + "Traceback (most recent call last):\n"
                + "  File \"/path/to/test/tests.py\", line 53, in test_case6\n"
                + "    self._assert(\"abzAZ!\", 27, \"bcaBA!\", None)\n"
                + "  File \"/path/to/test/tests.py\", line 32, in _assert\n"
                ...
                + "----------------------------------------------------------------------\n"
                + "Traceback (most recent call last):\n"
                + "  File \"/path/to/test/tests.py\", line 56, in test_case7\n"
    ...
    public void failLogHint() {
        List<String> actuals = extractAllHints(
                "F\n" + "======================================================================\n"
                        ...
                        + "----------------------------------------------------------------------\n"
                        + "Traceback (most recent call last):\n"
                        + "  File \"/path/to/test/tests.py\", line 84, in testFail\n"
                        + "    self.fail(m)\n"
    ...
    public void assertCountHint() {
        List<String> actuals = extractAllHints("FF\n"
                ...
                + "----------------------------------------------------------------------\n"
                + "Traceback (most recent call last):\n"
                + "  File \"/path/to/test/tests.py\", line 88, in testFail2\n"
                + "    self.assertCountEqual([], [1], m)\n" + "AssertionError: Element counts were not equal:\n"
    ...
    public void errorDueToIndentation() {
        List<String> actuals = extractAllHints("E\n"
                ...
                + "    __import__(name)\n"
                + "  File \"/path/to/test/tests.py\", line 17, in <module>\n"
                + "    from public import script\n"
                + "  File \"/path/to/test/tests.py\", line 14\n"
    ...
    public void extractionWorksWithMultipleHints() {
        List<String> actuals = extractAllHints("FF\n"
                ...
                + "----------------------------------------------------------------------\n"
                + "Traceback (most recent call last):\n"
                + "  File \"/path/to/test/tests.py\", line 52, in test_1\n"
                + "    self._assert([], [], [], \"empty\")\n"
                + "  File \"/path/to/test/tests.py\", line 41, in _assert\n"
                + "    self._assertType(list, actual)\n"
                + "  File \"/path/to/test/tests.py\", line 23, in _assertType\n"
                + "    self.fail(m)\n" + "AssertionError: @@First hint@@\n" + "\n"
                + "======================================================================\n"
                + "FAIL: test_2 (private.tests.PrivateTestSuite)\n"
                + "----------------------------------------------------------------------\n"
                + "Traceback (most recent call last):\n"
                + "  File \"/path/to/test/tests.py\", line 55, in test_2\n"
    ...
    public void importError() {
        List<String> actuals = extractAllHints("F\n"
                ...
                + "  File \"/path/to/test/tests.py\", line 52, in test_1\n"
                + "    self._assert([], [], [], \"empty\")\n"
                + "  File \"/path/to/test/tests.py\", line 30, in _assert\n"
    ...
    public void executionError() {
        List<String> actuals = extractAllHints("F\n"
                ...
                + "----------------------------------------------------------------------\n"
                + "Traceback (most recent call last):\n"
                + "  File \"/path/to/test/tests.py\", line 34, in _assert\n"
                + "    actual = merge(a, b)\n"
                + "  File \"/path/to/test/tests.py\", line 4, in merge\n"
                + "    xxx\n" + "NameError: name 'xxx' is not defined\n" + "\n"
                + "During handling of the above exception, another exception occurred:\n" + "\n"
                + "Traceback (most recent call last):\n"
                + "  File \"/path/to/test/tests.py\", line 52, in test_1\n"
                + "    self._assert([], [], [], \"empty\")\n"
                + "  File \"/path/to/test/tests.py\", line 38, in _assert\n"
    ...
    public void assertEqualDists() {
        List<String> actuals = extractAllHints("F\n"
                ...
                + "  File \"/path/to/test/tests.py\", line 48, in _assert\n"
    ...
    public void assertEqualDicts() {
        List<String> actuals = extractAllHints("F\n"
                ...
                + "----------------------------------------------------------------------\n"
                + "Traceback (most recent call last):\n"
                + "  File \"/path/to/test/tests.py\", line 59, in test_2\n"
                + "    self._assert({1:2}, {2:[1]})\n"
                + "  File \"/path/to/test/tests.py\", line 52, in _assert\n"
                + "    self.assertEqual(expected, actual, m)\n" + "AssertionError: {2: [1]} != {}\n" + "- {2: [1]}\n"
    ...
    public void errorDuringImport() {
        List<String> actuals = extractAllHints("Traceback (most recent call last):\n"
                ...
                + "    module = __import__(module_name)\n"
                + "  File \"/path/to/test/tests.py\", line 12, in <module>\n"
                + "    from public.script import analyze\n"
                + "  File \"/path/to/test/tests.py\", line 3, in <module>\n"
                + "    xxx\n" + "NameError: name 'xxx' is not defined");
    ...
    public void errorDuringExecution() {
        List<String> actuals = extractAllHints("E\n"
                ...
                + "----------------------------------------------------------------------\n"
                + "Traceback (most recent call last):\n"
                + "  File \"/path/to/test/tests.py\", line 60, in test01_empty_list\n"
                + "    self._assert([], {}, \"@@The result is not correct for an empty list of posts.@@\")\n"
                + "  File \"/path/to/test/tests.py\", line 42, in _assert\n"
                + "    actual = self._exec(_in)\n"
                + "  File \"/path/to/test/tests.py\", line 29, in _exec\n"
                + "    return analyze(_in)\n"
                + "  File \"/path/to/test/tests.py\", line 4, in analyze\n"
                + "    xxx\n" + "NameError: name 'xxx' is not defined\n" + "\n"
                + "----------------------------------------------------------------------\n" + "Ran 1 test in 0.001s\n"
                + "\n" + "FAILED (errors=1)");
    ...
    public void maxiTest() {
        String in = "FFFFFFFFFFFFFFFFFFF\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 62, in test_assertAlmostEqual\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 27, in test_assertDictEqual\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 37, in test_assertFalse\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 43, in test_assertIs\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 56, in test_assertIsInstance\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 50, in test_assertIsNone\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 47, in test_assertIsNot\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 53, in test_assertIsNotNone\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 24, in test_assertListEqual\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 65, in test_assertNotAlmostEqual\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 59, in test_assertNotIsInstance\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 34, in test_assertRaises\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 40, in test_assertTrue\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 21, in test_assertTupleEqual\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 18, in test_assert_equal_dict\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 9, in test_assert_equal_int\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 15, in test_assert_equal_list\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 12, in test_assert_equal_tuple\n" +
                ...
                "----------------------------------------------------------------------\n" +
                "Traceback (most recent call last):\n" +
                "  File \"/path/to/test/tests.py\", line 30, in test_fail\n" +
                "    self.fail(m(\"fail\"))\n" +
                "AssertionError: @@fail@@\n" +
                "----------------------------------------------------------------------\n" +
