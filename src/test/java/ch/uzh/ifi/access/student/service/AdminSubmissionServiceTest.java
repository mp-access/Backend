...
public class AdminSubmissionServiceTest {
    ...
    public void generateAssignmentReportTest() {
        ...
        Map<User, List<StudentSubmission>> testSubmissionsByStudent = Map.of(
        ...
        AssignmentReport testReport = new AssignmentReport(assignment, testUsersFound, testSubmissionsByStudent, List.of());
    ...
    public void invalidateSubmissionsByExerciseAndUserTest() {
        ...
        CodeSubmission testSubmissionUser1A = TestObjectFactory.createCodeAnswer(user1, exercise.getId());
        CodeSubmission testSubmissionUser1B = TestObjectFactory.createCodeAnswer(user1, exercise.getId());
        CodeSubmission testSubmissionUser2 = TestObjectFactory.createCodeAnswer(user2, exercise.getId());
        studentSubmissionService.initSubmission(testSubmissionUser1A);
        Assertions.assertFalse(testSubmissionUser1A.isInvalid());
        studentSubmissionService.initSubmission(testSubmissionUser1B);
        Assertions.assertFalse(testSubmissionUser1B.isInvalid());
        studentSubmissionService.initSubmission(testSubmissionUser2);
